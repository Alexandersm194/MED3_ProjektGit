import cv2
import numpy as np
import FishDirection as FigDir
...
input_image = cv2.imread("TrainingImages//Fisk.jpg")
...
box = FigDir.find_box(closedPicture)
...
ellipsisPic = input_image.copy()
ellipsis = FigDir.fit_ellipse(closedPicture)

cv2.ellipse(ellipsisPic, ellipsis, (0, 255, 0), 2)
cv2.namedWindow("Line", cv2.WINDOW_NORMAL)
cv2.imshow("Line", ellipsisPic)
